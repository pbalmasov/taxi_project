...
public class PreliminaryOrder extends Order {
    ...
    public PreliminaryOrder(Context context, String costRide,int index,Date date, String adress, Integer type, String orderText, String where) {
    ...
    public String toString() {
        ...
        return getTimeString(_date) + ", "+_context.getString(R.string.preliminary).toLowerCase()+", " + _addressdeparture;
    }
