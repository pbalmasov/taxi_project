...
public class MainListActivity extends BalanceActivity {
    ...
    private void initMainList() {
        ...
        if (driver != null) {
            ...
            itemsList.add(createItem("item",
                    this.getString(R.string.my_orders) + " " + driver.getOrdersCount()));
            itemsList
    ...
    private void exitDialog() {
        new AlertDialog.Builder(MainListActivity.this)
                .setTitle(this.getString(R.string.orders))
                .setMessage(this.getString(R.string.sorry_exit))
                .setPositiveButton(this.getString(R.string.exit_action),
                        onExitClickListener()).setNegativeButton(this.getString(R.string.cancel), null).show();
    }
